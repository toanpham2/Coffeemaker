...
public class APICoffeeTest {
    ...
    public void setup () {
        ...
        ivt.addIngredients( new Ingredient( "Chocolate", 15 ) );
        ivt.addIngredients( new Ingredient( "Coffee", 15 ) );
        ivt.addIngredients( new Ingredient( "Milk", 15 ) );
        ivt.addIngredients( new Ingredient( "Sugar", 15 ) );
    ...
    public void testPurchaseBeverage3 () throws Exception {
        ...
        final Inventory ivt = iService.getInventory();
        ivt.getOneIngredient( "Coffee" ).setAmount( 0 );
        iService.save( ivt );
